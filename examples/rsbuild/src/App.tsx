    ...
    >
      ...
      >
        <header style={{ display: 'grid', gap: '10px' }}>
          ...
          >
            One package, two bundlers, same edges.
          </h1>
          <p
            style={{
          ...
          >
            This verifies the export map from the consumer side, not from a direct source import.
          </p>
        </header>
        ...
        <ImageDropInput
          ...
          upload={async (file: Blob, context: UploadContext) => {
            ...
            return {
              ...
              key: 'example/rsbuild/avatar.png'
            };
          }}
        />
